...
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$y             Telegram : https://t.me/mochvpn $wh"
echo -e "$y           Premium Auto Script Mod By Mang Agus $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo ""
echo -e "$y SSH & OpenVPN $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$yy 1$y.Buat Akun SSH & OpenVPN"
echo -e "$yy 2$y.Buat Akun Trial SSH & OpenVPN"
echo -e "$yy 3$y.Perpanjang Masa Aktif Akun SSH & OpenVPN"
echo -e "$yy 4$y.Cek User Login SSH & OpenVPN"
echo -e "$yy 5$y.Daftar Member SSH & OpenVPN"
echo -e "$yy 6$y.Hapus Akun SSH & OpenVpn"
echo -e "$yy 7$y.Hapus Akun Expired SSH & OpenVPN"
echo -e "$yy 8$y.Set up Autokill SSH"
echo -e "$yy 9$y.Tampilkan Users SSH Yang Multi Login"
echo -e "$yy 10$y.Restart Semua Layanan"
echo -e ""
echo -e "$y L2TP $wh"
echo -e "$y-------------------------------------------------------------$wh"
...
echo -e "$y SYSTEM $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$yy 49$y.Tambah Atau Ubah Subdomain Host Untuk VPS"
echo -e "$yy 50$y.Ubah Port Layanan"
...
echo -e "$yy 55$y.Batasi Bandwith Speed Server"
echo -e "$yy 56$y.Cek Penggunaan RAM"
